...
_ENTITY_PATTERNS = re.compile(
    ...
    r"LLC|L\.L\.C|INC|CORP|TRUST|TRUSTEE|LTD|LP|L\.P|ASSOCIATES|HOLDINGS|"
    r"PROPERTIES|PARTNERS|GROUP|REALTY|MGMT|MANAGEMENT|CO\b|COMPANY|"
    r"ESTATE OF|C/O|INVESTMENTS|VENTURES|CAPITAL|WHOLESALE|RETAIL|BANK|"
    r"ENTERPRISES|SERVICE|UNION|PARTNERSHIP|ORGANIZATION|ACQUISITION|"
    r"MORTGAGE|NOMINEE|REMAINDERMAN|OWNER|"
    # Real estate / housing
    r"CONDO|CONDOMINIUM|COOP|CO-OP|HOUSING|APARTMENTS|TOWER|TOWERS|"
    r"PLAZA|COURT|GARDENS|ESTATES|TENANTS|DEVELOPMENT|HOMEOWNERS|RESIDENCES|"
    r"TERRACE|PLACE|BUILDING|AVALON|WAREHOUSE|PALACE|ARENA|PARC|"
    ...
    r"CITY|STATE|COUNTY|BOARD|TRANSIT|MTA|NYS|NYCHA|PORT|BRIDGE|PUBLIC|"
    r"FEDERAL|AGENCY|METROPOLITAN|MIDTOWN|TRIBOROUGH|DEPT|ADMINISTRATION|POLICE|"
    # Education / religion
    r"MUSEUM|CHURCH|SCHOOL|UNIVERSITY|HOSPITAL|FOUNDATION|CONGREGATION|"
    r"COLLEGE|INSTITUTE|ACADEMY|DIOCESE|CHARITIES|MISSIONS|TEMPLE|CATHEDRAL|PARISH|"
    r"YESHIVA|TALMUDICAL|BISHOP|"
    # General non-person
    r"CEMETERY|PARK|PARKS|FOREST|SQUARE|LIBRARY|MEDICAL|CLINIC|ASSOCIATION|CLUB|"
    r"CENTER|MEMORIAL|"
    # Placeholder names
...
# Regex to detect when an owner name is really a street address — either
# starting with digits ("145 READE ST") or containing a number range
# embedded anywhere ("583-587 BROADWAY" parsed as "Broadway 583-587").
...
_JUNK_NAME_PATTERNS = re.compile(
    ...
    r"REPUB|NATIONAL|ROYAL|FOREIGN|GENERAL|"
    r"SOCIETY|COUNCIL|COMMITTEE|"
