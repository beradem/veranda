...
_ENTITY_PATTERNS = re.compile(
    ...
    r"LLC|L\.L\.C|INC|CORP|TRUST|LTD|LP|L\.P|ASSOCIATES|HOLDINGS|"
    ...
    r"CITY|STATE|COUNTY|BOARD|TRANSIT|MTA|PORT|BRIDGE|PUBLIC|FEDERAL|AGENCY|METROPOLITAN|"
    # Education / religion
    ...
    # General non-person
    r"CEMETERY|PARK|FOREST|SQUARE|LIBRARY|MEDICAL|CLINIC|ASSOCIATION|CLUB|"
    # Placeholder names
